"""Setup Finance dataset with all 8 scenarios.

This script creates 8 scenario databases for the Finance dataset only.
Faster than setting up all 24 databases.

Usage:
    uv run python scripts/setup_finance_scenarios.py
"""
import sys
import time
...
def main():
    """Main entry point."""
    print_header("SETTING UP FINANCE SCENARIOS")
    print_info("This will create 1 dataset × 8 scenarios = 8 databases in OpenMetadata")
    print_info("Estimated time: 8-10 minutes")
    print()
    ...
    print_header("FINANCE SETUP COMPLETE")
    ...
    print_info("  4. Select Finance dataset in Interactive Demo Mode!")
